...
namespace GG_Ejercicio2tablas.Controllers
{
    public class BurgersController : Controller
    {
        ...
        public BurgersController(GG_Ejercicio2tablasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'GG_Ejercicio2tablasContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'GG_Ejercicio2tablasContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
